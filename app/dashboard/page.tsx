      ...
      <div className="max-w-7xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <span className="text-secondary-foreground text-sm font-medium">Hedge Delta</span>
                <div className="w-8 h-8 rounded-full bg-success/10 flex items-center justify-center">
                  <Shield className="w-4 h-4 text-success" />
                </div>
              </div>
              <div>
                <h3 className="text-3xl font-mono font-bold">Neutral</h3>
              ...
              <div className="p-4 flex items-center justify-between hover:bg-secondary/10 transition-colors">
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 rounded-full bg-blue-500 border-2 border-card" />
                    <div className="w-8 h-8 rounded-full bg-green-500 border-2 border-card" />
                  </div>
                  <div>
                    <div className="font-bold text-sm">ETH / USDC</div>
                    <div className="text-secondary-foreground text-[10px] font-bold uppercase tracking-wider">Uniswap v4</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-mono font-bold">$8,440.34</div>
                  <div className="text-[10px] text-secondary-foreground font-semibold">Allocated: 80%</div>
                </div>
              </div>
              <div className="p-4 flex items-center justify-between hover:bg-secondary/10 transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center border-2 border-card">
        ...
        <div className="lg:col-span-4 space-y-6">
            ...
            <div className="px-6 pb-6 space-y-4">
              <div className="p-4 rounded-xl border bg-background/50 focus-within:border-primary transition-colors group">
                <div className="flex justify-between mb-2">
                  <span className="text-[10px] font-bold text-secondary-foreground tracking-widest uppercase">You pay</span>
                  <span className="text-[10px] font-bold text-primary cursor-pointer hover:underline">MAX</span>
                </div>
              ...
              <div className="p-4 rounded-xl border bg-background/50">
                <div className="flex justify-between mb-2">
                  <span className="text-[10px] font-bold text-secondary-foreground tracking-widest uppercase">You receive (est)</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="text-2xl font-mono">0.0</div>
              ...
              <button className="w-full py-4 rounded-2xl bg-primary text-primary-foreground font-bold text-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
                Deposit USDC
              </button>
          ...
          >
            ...
            <button className="w-full mt-6 py-2 border rounded-xl text-xs font-bold hover:bg-secondary transition-colors flex items-center justify-center gap-2">
